...
class CollectionCountedTests: XCTestCase {
    ...
    static var allTests = [
        ("testCollectionCountedElementsZero", testCollectionCountedElementsZero),
        ("testCollectionCountedElementsOne", testCollectionCountedElementsOne),
        ("testCollectionCountedElementsTwo", testCollectionCountedElementsTwo),
        ("testCollectionCountedElementsThree", testCollectionCountedElementsThree),
        ("testCollectionCountedElementsFour", testCollectionCountedElementsFour),
    ]
