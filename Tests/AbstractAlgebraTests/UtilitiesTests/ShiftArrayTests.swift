...
class ShiftArrayTests: XCTestCase {
    ...
    static var allTests = [
        ("testShiftArrayOneToTenRightByOne", testShiftArrayOneToTenRightByOne),
        ("testShiftArrayOneToTenRightBySeven", testShiftArrayOneToTenRightBySeven),
        ("testShiftArrayOneToTenLeftByThree", testShiftArrayOneToTenLeftByThree),
    ]
