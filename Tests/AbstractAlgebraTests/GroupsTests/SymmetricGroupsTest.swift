...
class SymmetricGroupsTest: XCTestCase {
    ...
    static var allTests = [
        ("testElementNoInGroup", testElementNoInGroup),
        ("testInverseOfSymmetricGroup", testInverseOfSymmetricGroup),
        ("testFunctionCompositionOnOneLineNotation", testFunctionCompositionOnOneLineNotation),
        ("testFunctionCompositiononCyclicNotation", testFunctionCompositiononCyclicNotation),
        ("testFunctionCompositionWithIdentityResultsInElement", testFunctionCompositionWithIdentityResultsInElement),
        ("testOnOneLineNotation", testOnOneLineNotation),
        ("testCanonicalCycleNotation", testCanonicalCycleNotation),
    ]
