...
class SlidingWindowTests: XCTestCase {
    ...
    static var allTests = [
        ("testSlidingWindowEmpty", testSlidingWindowEmpty),
        ("testSlidingWindowSingleElement", testSlidingWindowSingleElement),
        ("testSlidingWindowArrayOfTwoElements", testSlidingWindowArrayOfTwoElements),
        ("testSlidingWindowArrayOfFourElements", testSlidingWindowArrayOfFourElements),
        ("testSlidingWindowArrayOf10Elements", testSlidingWindowArrayOf10Elements),
    ]
